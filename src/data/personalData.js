...
export const personalData = {
  ...
  profile: {
    ...
    facts: [
      { label: 'Primary identity', value: 'Engineer' },
      { label: 'Startup role', value: 'Founder and COO, Trident Ember Defense' },
      { label: 'Academic focus', value: 'Statistics, data science, and GIS' },
